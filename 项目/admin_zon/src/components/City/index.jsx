...
export default function City(props) {
  ...
  const getCity = (province) => {
    ...
    setCityList(gc1[province] ? gc1[province] : []);
  };
  const getCounty = (city) => {
    var gc2 = [];
    gc2["安徽"] = [];
    ...
    gc2["其他"]["智利"] = ["智利"];
    console.log(
      gc2[province] ? (gc2[province][city] ? gc2[province][city] : []) : []
    );
    setDistrictList(
      gc2[province] ? (gc2[province][city] ? gc2[province][city] : []) : []
    );
  ...
  return (
    <>
      ...
      <Form.Item
        label="市"
        name="city"
        rules={[{ required: true, message: "请输入所在市" }]}
      >
        {/* <Input placeholder="请输入所在市" /> */}
        <Select
          placeholder="请选择市"
          onChange={(value) => {
            setCity(value);
