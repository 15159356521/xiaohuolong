...
!(function (e) {
  ...
  (c.prototype.view = function () {
    ...
    var l = (function () {
      ...
      c = (function () {
        ...
        var e,
          t = (n.btn || []).length;
        return 0 !== t && n.btn
          ? ((e = '<span yes type="1">' + n.btn[0] + "</span>"),
    ...
    if (
      (n.fixed ||
        ((n.top = n.hasOwnProperty("top") ? n.top : 100),
        (n.style = n.style || ""),
        (n.style += " top:" + (t.body.scrollTop + n.top) + "px")),
      2 === n.type &&
        (n.content =
          ...
          "</p>"),
      n.skin && (n.anim = "up"),
      "msg" === n.skin && (n.shade = !1),
      (s.innerHTML =
        (n.shade
          ? "<div " +
            ("string" == typeof n.shade ? 'style="' + n.shade + '"' : "") +
            ' class="layui-m-layershade"></div>'
          : "") +
        '<div class="layui-m-layermain" ' +
        (n.fixed ? "" : 'style="position:static;"') +
        '><div class="layui-m-layersection"><div class="layui-m-layerchild ' +
        (n.skin ? "layui-m-layer-" + n.skin + " " : "") +
        (n.className ? n.className : "") +
        " " +
        (n.anim ? "layui-m-anim-" + n.anim : "") +
        '" ' +
    ...
    (c.prototype.action = function (e, t) {
      var n = this;
      e.time &&
        (l.timer[n.index] = setTimeout(function () {
          layer.close(n.index);
        }, 1e3 * e.time));
      var a = function () {
      ...
      if (e.btn)
        for (
          var s = t[i]("layui-m-layerbtn")[0].children, r = s.length, o = 0;
          o < r;
          o++
        )
          l.touch(s[o], a);
